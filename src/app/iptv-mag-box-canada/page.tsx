...
export const metadata: Metadata = {
  title: "IPTV MAG Box Canada – Setup & Best Plans 2026 | Maple4KTV",
  description:
    "Set up Maple4KTV IPTV on your MAG Box in Canada. Full portal URL setup guide. 25,000+ live channels, NHL, TSN in 4K. Plans from $19 CAD/month.",
  ...
  openGraph: {
    title: "IPTV MAG Box Canada – Setup & Best Plans 2026 | Maple4KTV",
    description: "Set up Maple4KTV IPTV on your MAG Box in Canada. Full portal URL setup guide. 25,000+ live channels, NHL, TSN in 4K. Plans from $19 CAD/month.",
...
const howToSchema = {
  ...
  "@type": "HowTo",
  name: "How to Set Up Maple4KTV IPTV on a MAG Box in Canada",
  description: "Configure your MAG Box with Maple4KTV portal URL in minutes.",
  step: [
    ...
    { "@type": "HowToStep", name: "Enter Portal URL", text: "Enter the Maple4KTV portal URL we send to your email after subscribing. Save and reboot." },
    { "@type": "HowToStep", name: "Start streaming", text: "Your MAG Box will load the Maple4KTV portal with 25,000+ Canadian and international channels." },
  ],
};
      ...
      <main style={{ background: "#0a0a0a", color: "#fff", minHeight: "100vh" }}>
        <section style={{ background: "linear-gradient(135deg, #0a0a0a 0%, #1a0505 100%)", padding: "80px 16px 60px" }}>
          <div style={{ maxWidth: 900, margin: "0 auto" }}>
            ...
            <p style={{ color: "#9ca3af", fontSize: 17, lineHeight: 1.7, maxWidth: 680, marginBottom: 36 }}>
              Maple4KTV is one of the best Maple4K providers for MAG Box users. Whether you have a MAG 322, 324, 351, or 410, our service works flawlessly with a simple portal URL setup — no technical knowledge required.
            </p>
        ...
        <section style={{ padding: "60px 16px", background: "#0d0d0d" }}>
          <div style={{ maxWidth: 900, margin: "0 auto" }}>
            <h2 style={{ fontSize: "clamp(24px, 3.5vw, 36px)", fontWeight: 800, marginBottom: 32 }}>
              Why Maple4KTV Works Great on MAG Box
            </h2>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: 20 }}>
              {[
                { title: "Native Portal Support", desc: "MAG boxes natively support IPTV portals. Maple4KTV provides a dedicated portal URL — no extra apps needed." },
        ...
        <section style={{ padding: "60px 16px", background: "#0a0a0a" }}>
          <div style={{ maxWidth: 780, margin: "0 auto" }}>
            <h2 style={{ fontSize: "clamp(24px, 3.5vw, 36px)", fontWeight: 800, marginBottom: 32 }}>
              How to Set Up Maple4KTV on Your MAG Box
            </h2>
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              {[
                { n: "01", title: "Subscribe to Maple4KTV", desc: "Choose a plan on our pricing page. All plans support MAG Box via portal URL. Pay with Interac e-Transfer." },
                ...
                { n: "04", title: "Enter Portal URL", desc: "Type in the Maple4KTV portal URL in the Portal 1 URL field. Save and reboot your MAG Box." },
        ...
        <section style={{ padding: "60px 16px", background: "#0d0d0d", textAlign: "center" }}>
          <div style={{ maxWidth: 600, margin: "0 auto" }}>
            ...
            <p style={{ color: "#9ca3af", marginBottom: 32, fontSize: 15 }}>
              Best Maple4K service for MAG boxes. Plans from $19 CAD/month with free 24-hour trial.
            </p>
