...
const steps = [
  ...
  },
  {
    ...
    description:
      "Your friend signs up and purchases at least a 12-month subscription to MapleHD.",
  },
  {
    number: "03",
...
const rules = [
  "The referred person must purchase at least a 1-year MapleHD subscription.",
  "Your bonus is added after payment verification is completed.",
  "The referred person must be a new customer who has never used MapleHD before.",
    ...
    <main className="bg-gray-950 text-white min-h-screen">
      ...
      <section className="bg-gradient-to-br from-gray-900 via-gray-950 to-black py-20 px-4 text-center">
        <div className="max-w-3xl mx-auto">
          <span className="inline-block bg-[#AE2448] text-white text-xs font-bold px-4 py-1.5 rounded-full mb-6 uppercase tracking-widest">
            Referral Program
          </span>
          <h1 className="text-4xl md:text-6xl font-extrabold mb-6 leading-tight">
            Refer a Friend,{" "}
            <span className="text-[#AE2448]">Get +1 Year Free</span>
          </h1>
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Share MapleHD with people you know and earn free subscription time when they join.
          </p>
      ...
      <section className="py-20 px-4">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-4">
            How It <span className="text-[#AE2448]">Works</span>
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {steps.map((step) => (
              <div
                key={step.number}
                className="relative bg-gray-900 border border-gray-800 rounded-2xl p-8 hover:border-[#6E1A37] transition-colors"
              >
                <div className="text-5xl font-extrabold text-[#AE2448] opacity-30 mb-4 leading-none">
                  {step.number}
                </div>
      ...
      <section className="py-16 px-4 bg-gray-900">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">
            Your <span className="text-[#AE2448]">Rewards</span>
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {rewardCards.map((card) => (
              <div
                key={card.title}
                className="bg-gray-950 border border-gray-800 rounded-2xl p-8 text-center hover:border-[#6E1A37] transition-colors"
              >
                <div className="text-[#AE2448] text-4xl font-extrabold mb-3">★</div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-4">
            Submit Your <span className="text-[#AE2448]">Referral</span>
          </h2>
      ...
      <section className="py-20 px-4 bg-gray-900">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-10">
            Program <span className="text-[#AE2448]">Rules</span>
          </h2>
          <div className="space-y-4">
            {rules.map((rule, i) => (
              ...
              >
                <span className="text-[#AE2448] font-bold text-lg mt-0.5">{i + 1}.</span>
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-[#6E1A37] to-gray-900 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-gray-300 mb-8">
            Try MapleHD free for 5 minutes — no credit card required. Then start referring and earn free years.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="/free-trial"
              className="bg-[#AE2448] hover:bg-[#6E1A37] text-white px-8 py-4 rounded-xl font-bold text-lg transition-colors"
            >
              Get Free Trial
            </a>
            <a
              href="/pricing"
              className="border border-[#AE2448] text-[#72BAA9] hover:bg-[#AE2448] hover:text-white px-8 py-4 rounded-xl font-bold text-lg transition-colors"
            >
              View Pricing
            </a>
          </div>
