...
export default function TermsOfServicePage() {
  return (
    <main
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "MapleHD", "item": "https://maplehd.ca"}, {"@type": "ListItem", "position": 2, "name": "Terms of Service", "item": "https://maplehd.ca/terms-of-service"}]}) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "WebPage", "name": "Terms of Service", "url": "https://maplehd.ca/terms-of-service", "inLanguage": "en-CA", "dateModified": "2026-07-19", "isPartOf": {"@type": "WebSite", "name": "MapleHD", "url": "https://maplehd.ca"}}) }} />
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-10 text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-3">4. Permitted Use</h2>
          ...
          <section>
            ...
            <div className="bg-gray-900 rounded-xl p-6 border border-gray-800">
              ...
              <p className="mt-2">WhatsApp: <a href="/msg/wa" target="_blank" rel="noopener noreferrer" className="text-[#72BAA9] hover:underline">WhatsApp</a></p>
            </div>
          </section>
        </div>
      </div>
