...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.maplehd.ca/iptv-android-canada" },
};
  ...
  return (
    <><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(howToSchema) }} /><main className="bg-gray-950 text-white min-h-screen">
      ...
      <section className="bg-gradient-to-br from-gray-900 via-gray-950 to-black py-20 px-4 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold mb-6 leading-tight">
            IPTV for <span className="text-[#AE2448]">Android Canada</span>
          </h1>
      ...
      <section className="py-20 px-4">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-4">
            How to Set Up IPTV on <span className="text-[#AE2448]">Android</span>
          </h2>
      ...
      <section className="py-20 px-4 bg-gray-900">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-10">
            IPTV Designed for <span className="text-[#AE2448]">Android Users</span>
          </h2>
      ...
      <section className="py-20 px-4">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-10">
            Android IPTV <span className="text-[#AE2448]">FAQ</span>
          </h2>
          <div className="space-y-6">
            {[
