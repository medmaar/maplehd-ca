...
export default function DisclaimerPage() {
  return (
    <main
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "MapleHD", "item": "https://maplehd.ca"}, {"@type": "ListItem", "position": 2, "name": "Disclaimer", "item": "https://maplehd.ca/disclaimer"}]}) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "WebPage", "name": "Disclaimer", "url": "https://maplehd.ca/disclaimer", "inLanguage": "en-CA", "dateModified": "2026-07-19", "isPartOf": {"@type": "WebSite", "name": "MapleHD", "url": "https://maplehd.ca"}}) }} />
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <section className="space-y-8 text-gray-300 leading-relaxed">
          ...
          <div>
            ...
            <p>
              MapleHD acts solely as a reseller and intermediary for third-party IPTV
          ...
          <div>
            ...
            <p className="mb-3">
              By using the MapleHD service, you acknowledge and agree that:
            </p>
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>MapleHD bears no liability for any content accessed through third-party providers.</li>
          ...
          <div>
            ...
            <p>
              ...
              MapleHD does not warrant that the service will be uninterrupted, error-free,
          ...
          <div>
            ...
            <p>
              To the maximum extent permitted by applicable law, MapleHD shall not be
