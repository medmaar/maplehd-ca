...
export const metadata: Metadata = {
  title: { absolute: "7 Connections IPTV Canada 3 Months — $168 | MapleHD" },
  description:
    "Get 7 simultaneous connections for $168. 25,000+ live channels, 4K quality, NHL, TSN, CTV and more. No contract. Credentials sent within 5 minutes.",
  alternates: { canonical: "https://maplehd.ca/pricing/7-devices/3-months" },
};
...
const productSchema = {
  "@context": "https://schema.org",
  "@type": "Product",
  name: "MapleHD 3 Months IPTV Plan — 7 Devices",
  description: "3 Months of IPTV access for 7 simultaneous connections. 25,000+ live channels in Canada including NHL, TSN, CTV, Sportsnet and 120,000+ VOD titles in 4K.",
  ...
  offers: {
    ...
    url: "https://maplehd.ca/pricing/7-devices/3-months",
  },
};
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mb-8">
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 16, marginTop: 10 }}>
                <span style={{ color: "#AE2448", fontWeight: 800, fontSize: "2rem" }}>Price : $168</span>
