...
const productSchema = {
  "@context": "https://schema.org",
  "@type": "Product",
  name: "MapleHD 6 Months IPTV Plan — 7 Devices",
  description: "6 Months of IPTV access for 7 simultaneous connections. 25,000+ live channels in Canada including NHL, TSN, CTV, Sportsnet and 120,000+ VOD titles in 4K.",
  ...
  offers: {
    ...
    url: "https://maplehd.ca/pricing/7-devices/6-months",
  },
};
      ...
      <main style={{ background: "#10131E", color: "#fff", minHeight: "100vh" }}>
        ...
        >
          <div className="max-w-2xl mx-auto">
            ...
            >
              <PlanOrderForm plan="6 Months - 7 Devices — $245" />
            </div>
