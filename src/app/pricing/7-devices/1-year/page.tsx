...
export const metadata: Metadata = {
  title: { absolute: "7 Connections IPTV Canada 1 Year — $315 | MapleHD" },
  description:
    "Get 7 simultaneous connections for $315. 25,000+ live channels, 4K quality, NHL, TSN, CTV and more. No contract. Credentials sent within 5 minutes.",
  alternates: { canonical: "https://maplehd.ca/pricing/7-devices/1-year" },
};
...
const productSchema = {
  "@context": "https://schema.org",
  "@type": "Product",
  name: "MapleHD 1 Year IPTV Plan — 7 Devices",
  description: "1 Year of IPTV access for 7 simultaneous connections. 25,000+ live channels in Canada including NHL, TSN, CTV, Sportsnet and 120,000+ VOD titles in 4K.",
  ...
  offers: {
    ...
    url: "https://maplehd.ca/pricing/7-devices/1-year",
  },
};
      ...
      <main style={{ background: "#10131E", color: "#fff", minHeight: "100vh" }}>
        ...
        >
          <div className="max-w-2xl mx-auto">
            ...
            >
              <PlanOrderForm plan="1 Year - 7 Devices — $315" />
            </div>
