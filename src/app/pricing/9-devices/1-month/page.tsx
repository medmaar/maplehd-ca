...
const productSchema = {
  "@context": "https://schema.org",
  "@type": "Product",
  name: "MapleHD 1 Month IPTV Plan — 9 Devices",
  description: "1 Month of IPTV access for 9 simultaneous connections. 25,000+ live channels in Canada including NHL, TSN, CTV, Sportsnet and 120,000+ VOD titles in 4K.",
  ...
  offers: {
    ...
    url: "https://maplehd.ca/pricing/9-devices/1-month",
  },
};
      ...
      <main style={{ background: "#10131E", color: "#fff", minHeight: "100vh" }}>
        ...
        >
          <div className="max-w-2xl mx-auto">
            ...
            >
              <PlanOrderForm plan="1 Month - 9 Devices — $81" />
            </div>
