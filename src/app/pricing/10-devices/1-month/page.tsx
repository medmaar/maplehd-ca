...
export const metadata: Metadata = {
  title: { absolute: "10 Connections IPTV Canada 1 Month — $90 | MapleHD" },
  description:
    "Get 10 simultaneous connections for $90. 25,000+ live channels, 4K quality, NHL, TSN, CTV and more. No contract. Credentials sent within 5 minutes.",
  alternates: { canonical: "https://maplehd.ca/pricing/10-devices/1-month" },
};
...
const productSchema = {
  "@context": "https://schema.org",
  "@type": "Product",
  name: "MapleHD 1 Month IPTV Plan — 10 Devices",
  description: "1 Month of IPTV access for 10 simultaneous connections. 25,000+ live channels in Canada including NHL, TSN, CTV, Sportsnet and 120,000+ VOD titles in 4K.",
  ...
  offers: {
    ...
    url: "https://maplehd.ca/pricing/10-devices/1-month",
  },
};
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mb-8">
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 16, marginTop: 10 }}>
                <span style={{ color: "#AE2448", fontWeight: 800, fontSize: "2rem" }}>Price : $90</span>
            ...
            >
              <PlanOrderForm plan="1 Month - 10 Devices — $90" />
            </div>
