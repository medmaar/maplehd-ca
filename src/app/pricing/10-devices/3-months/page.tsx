...
const productSchema = {
  "@context": "https://schema.org",
  "@type": "Product",
  name: "MapleHD 3 Months IPTV Plan — 10 Devices",
  description: "3 Months of IPTV access for 10 simultaneous connections. 25,000+ live channels in Canada including NHL, TSN, CTV, Sportsnet and 120,000+ VOD titles in 4K.",
  ...
  offers: {
    ...
    url: "https://maplehd.ca/pricing/10-devices/3-months",
  },
};
      ...
      <main style={{ background: "#10131E", color: "#fff", minHeight: "100vh" }}>
        ...
        >
          <div className="max-w-2xl mx-auto">
            ...
            >
              <PlanOrderForm plan="3 Months - 10 Devices — $240" />
            </div>
