...
export const metadata: Metadata = {
  title: { absolute: "6 Connections IPTV Canada 6 Months — $210 | MapleHD" },
  description:
    "Get 6 simultaneous connections for $210. 25,000+ live channels, 4K quality, NHL, TSN, CTV and more. No contract. Credentials sent within 5 minutes.",
  alternates: { canonical: "https://maplehd.ca/pricing/6-devices/6-months" },
};
...
const productSchema = {
  "@context": "https://schema.org",
  "@type": "Product",
  name: "MapleHD 6 Months IPTV Plan — 6 Devices",
  description: "6 Months of IPTV access for 6 simultaneous connections. 25,000+ live channels in Canada including NHL, TSN, CTV, Sportsnet and 120,000+ VOD titles in 4K.",
  ...
  offers: {
    ...
    url: "https://maplehd.ca/pricing/6-devices/6-months",
  },
};
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mb-8">
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 16, marginTop: 10 }}>
                <span style={{ color: "#AE2448", fontWeight: 800, fontSize: "2rem" }}>Price : $210</span>
            ...
            >
              <PlanOrderForm plan="6 Months - 6 Devices — $210" />
            </div>
