...
export const metadata: Metadata = {
  title: { absolute: "4 Connections IPTV Canada 3 Months — $99 | MapleHD" },
  description:
    "Get 4 simultaneous connections for $99. 25,000+ live channels, 4K quality, NHL, TSN, CTV and more. No contract. Credentials sent within 5 minutes.",
  alternates: { canonical: "https://maplehd.ca/pricing/4-devices/3-months" },
};

const faqItems: FaqItem[] = [
  {
    q: "How many devices can stream at the same time with this plan?",
    a: "This plan supports exactly 4 simultaneous connections. All 4 devices can stream different channels at the same time on your account.",
  },
  {
...
const productSchema = {
  "@context": "https://schema.org",
  "@type": "Product",
  name: "MapleHD 3 Months IPTV Plan — 4 Devices",
  description: "3 Months of IPTV access for 4 simultaneous connections. 25,000+ live channels in Canada including NHL, TSN, CTV, Sportsnet and 120,000+ VOD titles in 4K.",
  ...
  offers: {
    ...
    url: "https://maplehd.ca/pricing/4-devices/3-months",
  },
};
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mb-8">
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 16, marginTop: 10 }}>
                <span style={{ color: "#AE2448", fontWeight: 800, fontSize: "2rem" }}>Price : $99</span>
            ...
            >
              <PlanOrderForm plan="3 Months - 4 Devices — $99" />
            </div>
