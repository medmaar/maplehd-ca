...
export const metadata: Metadata = {
  title: { absolute: "4 Connections IPTV Canada 1 Year — $180 | MapleHD" },
  description:
    "Get 4 simultaneous connections for $180. 25,000+ live channels, 4K quality, NHL, TSN, CTV and more. No contract. Credentials sent within 5 minutes.",
  alternates: { canonical: "https://maplehd.ca/pricing/4-devices/1-year" },
};
...
const productSchema = {
  "@context": "https://schema.org",
  "@type": "Product",
  name: "MapleHD 1 Year IPTV Plan — 4 Devices",
  description: "1 Year of IPTV access for 4 simultaneous connections. 25,000+ live channels in Canada including NHL, TSN, CTV, Sportsnet and 120,000+ VOD titles in 4K.",
  ...
  offers: {
    ...
    url: "https://maplehd.ca/pricing/4-devices/1-year",
  },
};
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mb-8">
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 16, marginTop: 10 }}>
                <span style={{ color: "#AE2448", fontWeight: 800, fontSize: "2rem" }}>Price : $180</span>
            ...
            >
              <PlanOrderForm plan="1 Year - 4 Devices — $180" />
            </div>
