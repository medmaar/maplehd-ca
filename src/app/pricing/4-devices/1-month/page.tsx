...
export const metadata: Metadata = {
  title: { absolute: "4 Connections IPTV Canada 1 Month — $36 | MapleHD" },
  description:
    "Get 4 simultaneous connections for $36. 25,000+ live channels, 4K quality, NHL, TSN, CTV and more. No contract. Credentials sent within 5 minutes.",
  alternates: { canonical: "https://maplehd.ca/pricing/4-devices/1-month" },
};
...
const productSchema = {
  "@context": "https://schema.org",
  "@type": "Product",
  name: "MapleHD 1 Month IPTV Plan — 4 Devices",
  description: "1 Month of IPTV access for 4 simultaneous connections. 25,000+ live channels in Canada including NHL, TSN, CTV, Sportsnet and 120,000+ VOD titles in 4K.",
  ...
  offers: {
    ...
    url: "https://maplehd.ca/pricing/4-devices/1-month",
  },
};
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mb-8">
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 16, marginTop: 10 }}>
                <span style={{ color: "#AE2448", fontWeight: 800, fontSize: "2rem" }}>Price : $36</span>
            ...
            >
              <PlanOrderForm plan="1 Month - 4 Devices — $36" />
            </div>
