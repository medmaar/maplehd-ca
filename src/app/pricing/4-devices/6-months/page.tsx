...
export const metadata: Metadata = {
  title: { absolute: "4 Connections IPTV Canada 6 Months — $140 | MapleHD" },
  description:
  ...
  alternates: { canonical: "https://maplehd.ca/pricing/4-devices/6-months" },
};
...
const productSchema = {
  "@context": "https://schema.org",
  "@type": "Product",
  name: "MapleHD 6 Months IPTV Plan — 4 Devices",
  ...
  offers: {
    ...
    url: "https://maplehd.ca/pricing/4-devices/6-months",
  },
};
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mb-8">
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 16, marginTop: 10 }}>
                <span style={{ color: "#AE2448", fontWeight: 800, fontSize: "2rem" }}>Price : $140</span>
            ...
            >
              <PlanOrderForm plan="6 Months - 4 Devices — $140" />
            </div>
