...
export const metadata: Metadata = {
  title: { absolute: "8 Connections IPTV Canada 3 Months — $192 | MapleHD" },
  description:
  ...
  alternates: { canonical: "https://maplehd.ca/pricing/8-devices/3-months" },
};
...
const productSchema = {
  "@context": "https://schema.org",
  "@type": "Product",
  name: "MapleHD 3 Months IPTV Plan — 8 Devices",
  ...
  offers: {
    ...
    url: "https://maplehd.ca/pricing/8-devices/3-months",
  },
};
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mb-8">
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 16, marginTop: 10 }}>
                <span style={{ color: "#AE2448", fontWeight: 800, fontSize: "2rem" }}>Price : $192</span>
