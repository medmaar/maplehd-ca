...
export const metadata: Metadata = {
  title: { absolute: "8 Connections IPTV Canada 6 Months — $280 | MapleHD" },
  description:
    "Get 8 simultaneous connections for $280. 25,000+ live channels, 4K quality, NHL, TSN, CTV and more. No contract. Credentials sent within 5 minutes.",
  alternates: { canonical: "https://maplehd.ca/pricing/8-devices/6-months" },
};

const faqItems: FaqItem[] = [
  {
    q: "How many devices can stream at the same time with this plan?",
    a: "This plan supports exactly 8 simultaneous connections. All 8 devices can stream different channels at the same time on your account.",
  },
  {
...
const productSchema = {
  "@context": "https://schema.org",
  "@type": "Product",
  name: "MapleHD 6 Months IPTV Plan — 8 Devices",
  description: "6 Months of IPTV access for 8 simultaneous connections. 25,000+ live channels in Canada including NHL, TSN, CTV, Sportsnet and 120,000+ VOD titles in 4K.",
  ...
  offers: {
    ...
    url: "https://maplehd.ca/pricing/8-devices/6-months",
  },
};
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mb-8">
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 16, marginTop: 10 }}>
                <span style={{ color: "#AE2448", fontWeight: 800, fontSize: "2rem" }}>Price : $280</span>
            ...
            >
              <PlanOrderForm plan="6 Months - 8 Devices — $280" />
            </div>
