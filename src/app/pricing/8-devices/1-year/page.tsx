...
export const metadata: Metadata = {
  title: { absolute: "8 Connections IPTV Canada 1 Year — $360 | MapleHD" },
  description:
    "Get 8 simultaneous connections for $360. 25,000+ live channels, 4K quality, NHL, TSN, CTV and more. No contract. Credentials sent within 5 minutes.",
  alternates: { canonical: "https://maplehd.ca/pricing/8-devices/1-year" },
};
...
const productSchema = {
  "@context": "https://schema.org",
  "@type": "Product",
  name: "MapleHD 1 Year IPTV Plan — 8 Devices",
  ...
  offers: {
    ...
    url: "https://maplehd.ca/pricing/8-devices/1-year",
  },
};
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mb-8">
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 16, marginTop: 10 }}>
                <span style={{ color: "#AE2448", fontWeight: 800, fontSize: "2rem" }}>Price : $360</span>
            ...
            >
              <PlanOrderForm plan="1 Year - 8 Devices — $360" />
            </div>
