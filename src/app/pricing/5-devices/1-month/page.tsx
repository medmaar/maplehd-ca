...
export const metadata: Metadata = {
  title: { absolute: "5 Connections IPTV Canada 1 Month — $45 | MapleHD" },
  description:
    "Get 5 simultaneous connections for $45. 25,000+ live channels, 4K quality, NHL, TSN, CTV and more. No contract. Credentials sent within 5 minutes.",
  alternates: { canonical: "https://maplehd.ca/pricing/5-devices/1-month" },
};
...
const productSchema = {
  "@context": "https://schema.org",
  "@type": "Product",
  name: "MapleHD 1 Month IPTV Plan — 5 Devices",
  ...
  offers: {
    ...
    url: "https://maplehd.ca/pricing/5-devices/1-month",
  },
};
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mb-8">
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 16, marginTop: 10 }}>
                <span style={{ color: "#AE2448", fontWeight: 800, fontSize: "2rem" }}>Price : $45</span>
            ...
            >
              <PlanOrderForm plan="1 Month - 5 Devices — $45" />
            </div>
