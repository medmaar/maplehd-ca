...
const steps = [
  {
    ...
    detail: "Plans start at $9/month for 1 device. Multi-device plans are available for families. Start with a free 2-hour trial if you want to test first.",
...
const devices = [
  { name: "Amazon Fire Stick", desc: "All generations including 4K and Lite", guide: "/iptv-firestick-canada" },
  { name: "Samsung Smart TV", desc: "All Tizen-based models (2018+)", guide: "/iptv-samsung-tv-canada" },
...
export default function HowItWorksPage() {
  return (
    <main
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "MapleHD", "item": "https://maplehd.ca"}, {"@type": "ListItem", "position": 2, "name": "How IPTV Works in Canada", "item": "https://maplehd.ca/how-it-works"}]}) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "WebPage", "name": "How IPTV Works in Canada", "url": "https://maplehd.ca/how-it-works", "inLanguage": "en-CA", "dateModified": "2026-07-19", "isPartOf": {"@type": "WebSite", "name": "MapleHD", "url": "https://maplehd.ca"}}) }} />
      ...
      <section id="devices" className="py-20 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {devices.map((d) => (
              <div key={d.name} className="bg-gray-900 rounded-xl p-5 border border-gray-800 flex items-start gap-4">
